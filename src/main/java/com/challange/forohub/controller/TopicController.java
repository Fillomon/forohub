package com.challange.forohub.controller;

import com.challange.forohub.domains.answers.AnswerData;
import com.challange.forohub.domains.answers.AnswerRepository;
import com.challange.forohub.domains.answers.AnswerResponseData;
import com.challange.forohub.domains.answers.ServiceAnswer;
import com.challange.forohub.domains.topics.*;
...
@SecurityRequirement(name = "bearer-key") //para brindar acceso 
public class TopicController {
    ...
    public ResponseEntity<TopicResponseData> addTopic(@Valid @RequestBody DataTopic data, HttpServletRequest request, UriComponentsBuilder uriBuilder){
        ...
        var respuesta = new TopicResponseData(response);
